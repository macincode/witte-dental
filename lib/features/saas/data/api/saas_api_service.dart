...
class SaasApiService {
  SaasApiService(this._dioService);
  final DioService _dioService;

  Future<void> getSaasPlans() async {
    await _dioService.get(ApiEndpoints.getSaasPlans);
  }
  ...
  Future<void> getBusinessProfile() async {
    await _dioService.get(ApiEndpoints.getBusinessProfile);
  }
  ...
  Future<void> getAvailableHospitals() async {
    await _dioService.get(ApiEndpoints.getAvailableHospitals);
  }
