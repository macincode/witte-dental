...
class AppointmentlistManagement extends StatefulWidget {
  ...
  @override
  State<AppointmentlistManagement> createState() => _AppointmentlistManagementState();
}

class _AppointmentlistManagementState extends State<AppointmentlistManagement> {
 
  void _showAppointmentDetails(BuildContext context, String patientName, String doctorName, String appointmentId) {
    showDialog(
      context: context,
      ...
      clipBehavior: Clip.hardEdge,
          ...
          content: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 10),
                Text('Treatment Details:-', style: Theme.of(context)
                                      .textTheme
                                      .labelLarge
                                      ?.copyWith(
          ...
          actions: [
            TextButton(
              onPressed: () => Navigator.of(context).pop(),
              child: Text('Close',style: Theme.of(context)
                                      .textTheme
                                      .labelLarge
                                      ?.copyWith(
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(child: Text(value,style:Theme.of(context)
                                      .textTheme
                                      .displayMedium
                                      ?.copyWith(
